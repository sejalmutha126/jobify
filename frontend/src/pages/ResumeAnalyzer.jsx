...
export default function ResumeAnalyzer() {
    ...
    try {
      const response = await fetch('http://localhost:8000/jobs/analyze-resume', {
        ...
        body: JSON.stringify({
          ...
          job_description: jobDescription || 'Python Developer with FastAPI and React',
        }),
      })
      ...
      if (response.ok) {
        ...
        console.log('[Resume] API error, showing demo')
        setAnalysis(getDemoAnalysis())
      }
    } catch (error) {
      console.error('[Resume] Error:', error)
      console.log('[Resume] Using demo analysis')
      setAnalysis(getDemoAnalysis())
    } finally {
      setLoading(false)
    }
  ...
  const getDemoAnalysis = () => {
    return {
      match_score: 75,
      matching_keywords: ['Python', 'FastAPI', 'React', 'PostgreSQL', 'API Development'],
      missing_keywords: ['Docker', 'Kubernetes', 'AWS', 'CI/CD'],
      suggestions: [
        'Add Docker and container experience to your resume',
        'Highlight cloud deployment experience (AWS, Azure, or GCP)',
        'Include metrics and achievements for each project',
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Paste your resume content here... or click 'Sample Resume' below"
              ...
              />
              <button
                onClick={() => setResumeText('Senior Python Developer\n\nExperience:\n- 5+ years Python development\n- FastAPI and Django expert\n- PostgreSQL and MongoDB\n- React frontend experience\n- RESTful API design\n- Git and version control\n\nSkills: Python, FastAPI, Django, React, PostgreSQL, MongoDB, Docker, AWS')}
